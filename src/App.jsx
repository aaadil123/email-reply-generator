...
function App() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post("https://email-reply-latest-t7kt.onrender.com/api/email/generate", {
       emailContent,
       tone 
      });
  ...
  //   const res = await axios.post("https://email-reply-latest-t7kt.onrender.com/api/email/test");
